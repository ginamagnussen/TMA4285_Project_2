...
The data set consists of total number of international airline passengers for each month from January 1949 to December 1960, giving a total number of $N=144$ observations.
```{r, echo = FALSE}
...
```
Consider now the ACF and th PACF of the last differenced series.
```{r}
